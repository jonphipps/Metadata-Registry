...
Route::namespace('Auth')->as('auth.')->group(function () {
    ...
    Route::middleware('guest')->group(function () {
        ...
        Route::name('password.email')->get('password/email', 'ForgotPasswordController@showLinkRequestForm');
        Route::name('password.name')->get('password/reset', 'ForgotPasswordController@showLinkRequestFormForName');
        Route::name('password.email')->post('password/email', 'ForgotPasswordController@sendLoginNameEmail');
        Route::name('password.name')->post('password/name', 'ForgotPasswordController@sendResetLinkEmailForName');
