...
class ProfilePropertyCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel(ProfileProperty::class);
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/profileproperty');
        $this->crud->setEntityNameStrings('profileproperty', 'profile_properties');
