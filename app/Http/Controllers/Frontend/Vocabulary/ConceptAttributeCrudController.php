...
class ConceptAttributeCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel(ConceptAttribute::class);
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/conceptattribute');
        $this->crud->setEntityNameStrings('conceptattribute', 'concept_attributes');
