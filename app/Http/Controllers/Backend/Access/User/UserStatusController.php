...
class UserStatusController extends Controller
{
   ...
   *
    ...
    return redirect()
        ->route($status == 1 ? "admin.access.user.index" : "admin.access.user.deactivated")
   ...
   *
    ...
    return redirect()
        ->route('admin.access.user.deleted')
        ->withFlashSuccess(trans('alerts.backend.users.deleted_permanently'));
	}
