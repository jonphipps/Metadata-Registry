...
trait RoleAttribute
{
    ...
    {
        return '<a href="' .
            route( 'admin.access.role.edit', $this ) .
    ...
    public function getDeleteButtonAttribute()
    {
        ...
        if ( $this->id != 1 ) {
            return '<a href="' .
                route( 'admin.access.role.destroy', $this ) .
                '"
                data-method="delete"
                ...
                '"
                class="btn btn-xs btn-danger"><i class="fa fa-times" data-toggle="tooltip" data-placement="top" title="' .
                trans( 'buttons.general.crud.delete' ) .
                '"></i></a>';
        }
