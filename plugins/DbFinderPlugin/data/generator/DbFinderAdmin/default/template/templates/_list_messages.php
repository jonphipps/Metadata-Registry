...
<div class="form-errors">
  <h2>[?php echo __s('Could not delete the selected %name%', array('%name%' => '<?php echo sfInflector::humanize($this->getSingularName()) ?>')) ?]</h2>
  <ul>
...
<div class="save-ok">
<h2>[?php echo __s($sf_user->getFlash('notice')) ?]</h2>
</div>
<?php else: ?>
