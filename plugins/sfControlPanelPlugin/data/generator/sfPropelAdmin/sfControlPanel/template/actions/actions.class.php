...
class <?php echo $this->getGeneratedModuleName() ?>Actions extends sfActions
{
  ...
  {
    return $this->forward('auto<?php echo $this->getModuleName() ?>', 'list');
  }
...
<?php endif ?>
  ...
  {
    return $this->forward('auto<?php echo $this->getModuleName() ?>', 'edit');
  }
  ...
  public function executeEdit ()
  {
    ...
    if ($this->getRequest()->getMethod() == sfRequest::POST)
    {
      ...
      {
        return $this->redirect('auto<?php echo $this->getModuleName() ?>/create');
      }
      else
      {
        return $this->redirect('auto<?php echo $this->getModuleName() ?>/edit?<?php echo $this->getPrimaryKeyUrlParams('this->') ?>);
      }
    }
    else
    {
  ...
  public function executeDelete ()
  {
    ...
    try
    {
      ...
      return $this->redirect('auto<?php echo $this->getModuleName() ?>/list');
    }
