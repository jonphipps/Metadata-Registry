...
<?php foreach ($this->getTableMap()->getColumns() as $column): ?>
  ...
  <td>[?php echo link_to($<?php echo $this->getSingularName() ?>->get<?php echo $column->getPhpName() ?>(), '<?php echo $this->getRestRoute('show') ?>?<?php echo $this->getPrimaryKeyUrlParams() ?>) ?]</td>
  <?php else: ?>
