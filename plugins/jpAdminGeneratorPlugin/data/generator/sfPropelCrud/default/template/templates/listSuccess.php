...
<?php foreach ($this->getTableMap()->getColumns() as $column): ?>
  ...
  <td>[?php echo sf_link_to($<?php echo $this->getSingularName() ?>->get<?php echo $column->getPhpName() ?>(), '@<?php echo $this->getModuleName() ?>_show?<?php echo $this->getPrimaryKeyUrlParams() ?>) ?]</td>
  <?php else: ?>
