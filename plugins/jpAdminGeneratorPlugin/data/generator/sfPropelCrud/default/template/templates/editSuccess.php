...
[?php if (<?php echo $this->getPrimaryKeyIsSet() ?>): ?]
  ...
  &nbsp;[?php echo sf_link_to('cancel', '@<?php echo $this->getModuleName() ?>_show?<?php echo $this->getPrimaryKeyUrlParams() ?>) ?]
[?php else: ?]
  &nbsp;[?php echo sf_link_to('cancel', '@<?php echo $this->getModuleName() ?>_list') ?]
[?php endif; ?]
</form>
