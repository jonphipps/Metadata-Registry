  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in sfBlogLogPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c->add(sfBlogPostPeer::AUTHOR_ID, $obj->getId());
			$affectedRows += sfBlogPostPeer::doDelete($c, $con);

			// delete related sfBlogUser objects
			$c = new Criteria(sfBlogUserPeer::DATABASE_NAME);
			
			$c->add(sfBlogUserPeer::USER_ID, $obj->getId());
			$affectedRows += sfBlogUserPeer::doDelete($c, $con);

			// delete related sfBlogLog objects
			$c = new Criteria(sfBlogLogPeer::DATABASE_NAME);
			
			$c->add(sfBlogLogPeer::USER_ID, $obj->getId());
			$affectedRows += sfBlogLogPeer::doDelete($c, $con);
