...
class RolePermissionTest extends TestCase {
	...
	public function testSavePermissionsToRole() {
		...
		$this->seeInDatabase($this->permissionRoleTable, ['permission_id' => 1, 'role_id' => $this->userRole->id]);
		$this->seeInDatabase($this->permissionRoleTable, ['permission_id' => 2, 'role_id' => $this->userRole->id]);
		$this->notSeeInDatabase($this->permissionRoleTable, ['permission_id' => 3, 'role_id' => $this->userRole->id]);
	}
