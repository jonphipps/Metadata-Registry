<?php  //[STAMP] b02bfeb35098dadc7ffb438e5dafc11a
...
use Helper\Import;
use Helper\ImportUpdate;
use Codeception\Module\Db;
use Codeception\Module\Filesystem;

trait ImportTesterActions
{
    /**
     ...
     * @see \Helper\Import::seeRecordCountInDatabaseTable()
     */
    public function canSeeRecordCountInDatabaseTable($table, $TestCount, $criteria = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeRecordCountInDatabaseTable', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function seeRecordCountInDatabaseTable($table, $TestCount, $criteria = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeRecordCountInDatabaseTable', func_get_args()));
    }
     ...
     * @see \Helper\Import::resetDatabase2()
     */
    public function resetDatabase2($dumpFile) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('resetDatabase2', func_get_args()));
    }
     ...
     *
     * @return array|bool
     * @see \Helper\ImportUpdate::getArrayFromSql()
     */
    public function getArrayFromSql($sql) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getArrayFromSql', func_get_args()));
    }
     ...
     *
     * @return array
     * @see \Helper\ImportUpdate::getArrayFromCsv()
     */
    public function getArrayFromCsv($CsvHeader, $CsvValues, $exclude = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getArrayFromCsv', func_get_args()));
    }
