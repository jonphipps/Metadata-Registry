START TRANSACTION;
UPDATE reg_schema_property_element SET reg_schema_property_element.profile_property_id=3 WHERE reg_schema_property_element.id=14195;
UPDATE reg_schema_property_element_history SET reg_schema_property_element_history.profile_property_id=3 WHERE reg_schema_property_element_history.id=16796;
UPDATE reg_schema_property_element SET reg_schema_property_element.profile_property_id=7 WHERE reg_schema_property_element.id=18780;
UPDATE reg_schema_property_element_history SET reg_schema_property_element_history.profile_property_id =7 WHERE reg_schema_property_element_history.id =25526;

DELETE FROM reg_schema_property_element WHERE reg_schema_property_element.id=14198;
DELETE FROM reg_schema_property_element WHERE reg_schema_property_element.id=14154;
...
(
        ...
        FROM
            reg_schema               AS s,
            reg_schema_property_i18n AS i,
            reg_schema_property      AS p
        WHERE
            p.id=i.id
...
SET reg_schema.languages =  tmp.NEWlanguage;
...
ALTER TABLE
    reg_schema_property_i18n MODIFY lexical_uri TEXT;

/* update lexical URIs in i18n */
UPDATE reg_schema, reg_schema_property, reg_schema_property_i18n
...
FROM
    reg_schema_property_i18n as i18n, reg_schema_property as p
WHERE i18n.id = p.id
...
SELECT
    ...
    p.status_id as status_id
FROM
    reg_schema_property as p, `reg_schema_property_element` as e
...
UPDATE reg_schema_property
       LEFT JOIN reg_schema_property AS uri
...
UPDATE reg_schema_property SET type = 'Class' WHERE type = 'subclass';
UPDATE reg_schema_property SET type = 'Property' WHERE type = 'subproperty';

UPDATE reg_schema_property_element SET object = 'Class' WHERE object = 'subclass' or object = 'class';
UPDATE reg_schema_property_element SET object = 'Property' WHERE object = 'subproperty' or object = 'property';

UPDATE reg_schema_property_element_history SET object = 'Class' WHERE object = 'subclass' or object = 'class';
UPDATE reg_schema_property_element_history SET object = 'Property' WHERE object = 'subproperty' or object = 'property';
