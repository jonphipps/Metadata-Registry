...
class ProfileSeeder extends Seeder
{
   ...
   */
    public function run()
    {
        ...
        $updateStatement = "
        INSERT INTO `projects` (`id`, `name`, `label`, `description`, `is_private`, `created_at`, `updated_at`, `deleted_at`, `repo`, `url`, `license`, `uri_strategy`, `uri_type`, `uri_prepend`, `uri_append`, `created_by`, `updated_by`, `deleted_by`, `starting_number`, `license_uri`, `default_language_id`, `google_sheet_url`) VALUES 
