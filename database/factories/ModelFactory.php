...
$factory->define(App\Models\ElementAttribute::class, function (Faker\Generator $faker) {
    return [
        'action' => $faker,
        'concept_property_id' => $faker,
        'concept_id' => $faker,
...
$factory->define(App\Models\VocabularyHasVersion::class, function (Faker\Generator $faker) {
    return [
        'name' => $faker,
        'created_at' => $faker,
        'deleted_at' => $faker,
...
$factory->defineAs(App\Models\Element::class, 'ElementFull', function (Faker\Generator $faker) use ($factory) {
