    ...
    Schema::table('reg_schema_property_element_history',
        function (Blueprint $table) {
          $table->foreign('created_user_id', 'reg_schema_property_element_history_ibfk_1')
              ...
              ->onUpdate('NO ACTION')
              ->onDelete('NO ACTION');
          $table->foreign('schema_property_element_id',
                          'reg_schema_property_element_history_ibfk_2')
              ->references('id')
          ...
          $table->foreign('schema_id', 'reg_schema_property_element_history_ibfk_4')
              ...
              ->onUpdate('NO ACTION')
              ->onDelete('SET NULL');
          $table->foreign('related_schema_property_id',
                          'reg_schema_property_element_history_ibfk_5')
              ->references('id')
              ->on('reg_schema_property')
              ->onUpdate('NO ACTION')
              ->onDelete('SET NULL');
