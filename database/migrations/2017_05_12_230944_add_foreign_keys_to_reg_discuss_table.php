...
class AddForeignKeysToRegDiscussTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->foreign('created_user_id', 'reg_discuss_ibfk_1')->references('id')->on('users')->onUpdate('RESTRICT')->onDelete('RESTRICT');
			$table->foreign('created_by', 'reg_discuss_ibfk_10')->references('id')->on('users')->onUpdate('RESTRICT')->onDelete('RESTRICT');
			$table->foreign('deleted_by', 'reg_discuss_ibfk_11')->references('id')->on('users')->onUpdate('RESTRICT')->onDelete('RESTRICT');
			$table->foreign('concept_property_id', 'reg_discuss_ibfk_12')->references('id')->on('reg_concept_property')->onUpdate('RESTRICT')->onDelete('CASCADE');
			$table->foreign('deleted_user_id', 'reg_discuss_ibfk_2')->references('id')->on('users')->onUpdate('RESTRICT')->onDelete('RESTRICT');
	...
	public function down()
	{
		Schema::table('reg_discuss', function(Blueprint $table)
		{
			...
			$table->dropForeign('reg_discuss_ibfk_11');
			$table->dropForeign('reg_discuss_ibfk_12');
