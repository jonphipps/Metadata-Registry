...
namespace Selenium
{
	...
	public class DefaultSelenium : ISelenium
	{
		...
		/// <summary>Simulates a user pressing the mouse button (without releasing it yet) at
		...
		/// <summary>Undo the effect of calling chooseCancelOnNextConfirmation.  Note
		...
		/// <summary>Returns every instance of some attribute from all known windows.
		/// </summary>
		...
		/// <summary>Returns the IDs of all windows that the browser knows about.
		/// </summary>
		/// <returns>the IDs of all windows that the browser knows about.</returns>
		...
		/// <summary>Returns the names of all windows that the browser knows about.
		/// </summary>
		/// <returns>the names of all windows that the browser knows about.</returns>
		...
		/// <summary>Returns the titles of all windows that the browser knows about.
		/// </summary>
		...
		/// <summary>Delete a named cookie with specified path.
		/// </summary>
