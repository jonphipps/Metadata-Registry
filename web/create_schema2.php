...
foreach ($frbrElements as $frbrElement):
  ...
  if (count($rdaSelected) && !isset($rdaSelected[$frbrElementName][0])): //frbrElement node does not exist in POST
    //note: http://www.kavoir.com/2008/12/how-to-delete-remove-nodes-in-simplexml.html
    //delete the node
...
?>
  <li>
    <input type="checkbox" name="<?php echo $frbrElementName . "[0]" ?>" value="Include" checked="checked" />
    <label class="tree"><?php echo $frbrElementDoc ?></label>
    <div class="mandatory">
        <input type="radio" name="<?php echo $frbrElementName ?>_rad" id="<?php echo $frbrElementName . "_rad_1" ?>" value="Mandatory" <?php echo $minChecked ?> />
        <label for="<?php echo $frbrElementName . "_rad_1" ?>" >Mandatory</label>
        &nbsp;&nbsp;<input type="radio" name="<?php echo $frbrElementName ?>_rad" id="<?php echo $frbrElementName . "_rad_2" ?>" value="Optional" <?php echo $optChecked ?> />
...
<?php
 ...
 //for each element
  foreach ($rdaElements as $rdaElement):
    ...
    if ($rdaSubElements)
    {
      $liName = $frbrElementName . "[" . $rdaElementName . "][0]";
    }
    else
    {
    ...
    //check to see if this node has been deleted
    if (count($rdaSelected) && !isset($rdaSelected[$frbrElementName][$rdaElementName][0])): //rdaElement node does not exist in POST
      //delete the node
  ...
  if ($displayOn):?>
    <li>
      <input type="checkbox" name="<?php echo $liName ?>" value="Include" checked="checked" />
...
<!--      <a class="load-local" href="#<?php echo $docId ?>" rel="#<?php echo $docId ?>"><img src="images/note2.gif" alt="" height="10" width="8" /></a> -->
      <div class="mandatory">
          <input type="radio" name="<?php echo $rdaElementName ?>_rad" id="<?php echo $rdaElementName . "_rad_1" ?>" value="Mandatory" <?php echo $minChecked ?> />
          <label for="<?php echo $rdaElementName . "_rad_1" ?>" >Mandatory</label>
          &nbsp;&nbsp;<input type="radio" name="<?php echo $rdaElementName ?>_rad" id="<?php echo $rdaElementName . "_rad_2" ?>" value="Optional" <?php echo $optChecked ?> />
          <label for="<?php echo $rdaElementName . "_rad_2" ?>" >Optional</label>
      </div>
      <div class="frbrDoc" id="<?php echo $docId ?>">
...
<?php
      ...
      foreach ($rdaSubElements as $rdaSubElement):
        ...
        //check to see if this node has been deleted
        if (count($rdaSelected) && !isset($rdaSelected[$frbrElementName][$rdaElementName][$rdaSubElementName])): //rdaSubElement node does not exist in POST
          //delete the node
...
?>
      <li>
        ...
        <div class="mandatory">
            <input type="radio" name="<?php echo $rdaSubElementName ?>_rad" id="<?php echo $rdaSubElementName . "_rad_1" ?>" value="Mandatory" <?php echo $minSubChecked ?> />
            <label for="<?php echo $rdaSubElementName . "_rad_1" ?>" >Mandatory</label>
            &nbsp;&nbsp;<input type="radio" name="<?php echo $rdaSubElementName ?>_rad" id="<?php echo $rdaSubElementName . "_rad_2" ?>" value="Optional" <?php echo $optSubChecked ?> />
            <label for="<?php echo $rdaSubElementName . "_rad_2" ?>" >Optional</label>
        </div>
        <div class="frbrDoc" id="<?php echo $docId ?>">
