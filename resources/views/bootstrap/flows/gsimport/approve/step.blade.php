...
@section('page-title')
    {{ Translate::recursive('flows.gsimport.approveStep.title') }}
@endsection
...
@section('content')
    ...
    {!! Form::open(array('route' => array('flows.step', $flow->id, 'approve'), 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form')) !!}
