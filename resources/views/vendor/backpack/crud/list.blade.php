...
@section('header')
	<section class="content-header">
	  ...
	  <ol class="breadcrumb">
@if(Auth::check())
	    <li><a href="{{ url(config('backpack.base.route_prefix'), 'dashboard') }}">{{ trans('navs.frontend.dashboard') }}</a></li>
@else
	    <li><a href="{{ url(config('backpack.base.route_prefix'), '') }}">{{ trans('navs.general.home') }}</a></li>
@endif
