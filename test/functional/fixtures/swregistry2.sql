...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='InnoDB free: 0 kB; (`user_id`) REFER `swregistry/reg_agents`';
...
INSERT INTO `reg_status` (`id`,`display_order`,`display_name`) VALUES
 (1,7,'Published'),
 (2,1,'New-Proposed'),
 (3,2,'Change-Proposed'),
 (4,3,'Deprecate-Proposed'),
 (5,4,'New-Under Review'),
 (6,5,'Change-Under Review'),
 (7,6,'Deprecate-Under Review'),
 (8,8,'Deprecated'),
 (9,9,'Not Approved');
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='InnoDB free: 0 kB; (`agent_id`) REFER `swregistry/reg_agent`';
