...
# Generation Time: 2014-04-23 21:35:06 +0000
# ************************************************************
...
VALUES
	...
	(8,'2008-04-20 12:05:00','2008-04-20 16:05:00',NULL,36,36,NULL,1,NULL,NULL,'hasSubproperty','hasSubproperty',NULL,NULL,'property','reg:hasSubproperty',1,'en',NULL,7,7,NULL,0,0,0,0,6,0,1,1,1,0,0),
	...
	(23,'2014-01-18 04:04:02','2014-01-18 04:04:02',NULL,422,422,NULL,1,NULL,NULL,'narrowMatch','narrowMatch',NULL,NULL,'property','skos:narrowMatch',1,'en',NULL,24,24,NULL,0,0,0,1,NULL,1,0,1,1,1,1),
	(24,'2014-01-18 04:04:01','2014-01-18 04:04:01',NULL,422,422,NULL,1,NULL,NULL,'closeMatch','closeMatch',NULL,NULL,'property','skos:closeMatch',1,'en',NULL,23,23,NULL,0,0,0,1,NULL,1,0,1,1,1,1),
	(25,'2014-01-18 04:04:00','2014-01-18 04:04:00',NULL,422,422,NULL,1,NULL,NULL,'broadMatch','broadMatch',NULL,NULL,'property','skos:broadMatch',1,'en',NULL,22,22,NULL,0,0,0,1,NULL,1,0,1,1,1,1),
	(26,'2014-01-18 04:04:00','2014-01-18 04:04:00',NULL,422,422,NULL,1,NULL,NULL,'lexicalUri','sameAs',NULL,NULL,'property','owl:sameAs',1,'en',NULL,22,25,NULL,1,0,0,0,NULL,1,0,1,1,0,0);
...
CREATE TABLE `reg_concept` (
  ...
  CONSTRAINT `reg_concept_FK_1` FOREIGN KEY (`status_id`) REFERENCES `reg_status` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
# Dump of table reg_concept_i18n
# ------------------------------------------------------------

DROP TABLE IF EXISTS `reg_concept_i18n`;

CREATE TABLE `reg_concept_i18n` (
  `id` int(11) NOT NULL,
  `culture` varchar(7) NOT NULL DEFAULT 'en',
  `pref_label` varchar(255) NOT NULL,
  PRIMARY KEY (`id`,`culture`),
  UNIQUE KEY `unique_pref_label` (`id`,`culture`,`pref_label`),
  CONSTRAINT `reg_concept_i18n_ibfk_1` FOREIGN KEY (`id`) REFERENCES `reg_concept` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
# Dump of table reg_schema_property_i18n
# ------------------------------------------------------------
...
CREATE TABLE `reg_schema_property_i18n` (
  ...
  `definition` text,
  `comment` text,
  `lexical_uri` varchar(255) NOT NULL,
  `note` text,
  PRIMARY KEY (`id`,`culture`),
...
INSERT INTO `reg_user` (`id`, `created_at`, `last_updated`, `deleted_at`, `nickname`, `salutation`, `first_name`, `last_name`, `email`, `sha1_password`, `salt`, `want_to_be_moderator`, `is_moderator`, `is_administrator`, `deletions`, `password`, `culture`)
VALUES
	(1,'2006-03-24 17:29:24','2007-06-04 15:04:28',NULL,'joeadmin',NULL,'Joe','Admin','admin@example.com','ad595c0e9bc6b0a9be194ad5bbcb2cd82eaee6ce','1d4c1324f5cacadf382702601d32c107',NULL,0,1,0,NULL,'en_US'),
	(2,'2010-05-16 03:54:59','2010-05-16 07:54:59',NULL,'admin',NULL,NULL,NULL,'admin@foobar.com','a56b209fbde14d37a6cee7507d0017de93ead3cf','4a7e518b8b6bc8d25a35a72632900bb1',0,0,0,0,NULL,'en_US'),
	(4,'2014-04-22 21:47:53','2014-04-22 21:47:53',NULL,'sysadmin',NULL,NULL,NULL,'sysadmin@metadataregistry.org','f8e92034977f6b236f60879d74097630545ccc74','2fd4d78ebe416a048f16604c52c5dc72',0,0,0,0,NULL,'en_US');
...
CREATE TABLE `reg_vocabulary` (
  ...
  CONSTRAINT `reg_vocabulary_ibfk_1` FOREIGN KEY (`profile_id`) REFERENCES `profile` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
