...
class StringHelper {
     ...
     * @return string
     */
    public function multiply($strings, $tokens, $replacements) {
     ...
     */
    public function unqualify($qualifiedName, $separator = '.') {
     ...
     * @return string
     */    
    public function qualifier($qualifiedName, $seperator = '.') {
     ...
     * @return array String[]
     */ 
    public function prefix( $columns, $prefix) {
     ...
     * @return string
     */ 
    public function root($qualifiedName, $separator = '.') {
