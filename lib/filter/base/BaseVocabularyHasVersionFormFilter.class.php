...
/**
 * VocabularyHasVersion filter form base class.
 *
 * @package    registry
 * @subpackage filter
 ...
 */
class BaseVocabularyHasVersionFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('vocabulary_has_version_filters[%s]');
