...
/**
 * SchemaHasUser filter form base class.
 *
 * @package    registry
 * @subpackage filter
 ...
 */
class BaseSchemaHasUserFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('schema_has_user_filters[%s]');
