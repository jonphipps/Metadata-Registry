...
version:  2008-08-01 (Addition: basic support for fixing chunked responses despite sending an HTTP 1.0 request
                      Tweak: including a snippet from the response body in the error message in case of 4xx reponses
                      Addition: added ping_only config option for background processes)
*/
...
class ARC2_Reader extends ARC2_Class {
  ...
  function activate($path, $data = '', $ping_only = 0) {
