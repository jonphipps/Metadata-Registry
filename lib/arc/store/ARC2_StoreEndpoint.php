...
class ARC2_StoreEndpoint extends ARC2_Store {
  ...
  function getHTMLDocBody() {
    return '
    	<body>
      <div style="margin:0; border-bottom: 2px solid red; height:73px;">
        <a href="/"><img style="margin: 0px 0px 0px -8px;" border=0 alt="registry" align="left" src="/images/open_metadata_logo_with_interoperability.png"></a>
        <br style="clear:all;" />
      </div>
