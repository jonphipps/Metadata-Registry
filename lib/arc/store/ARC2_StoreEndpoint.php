...
version:  2008-08-04 (Fix: No headers for DUMP queries, added Vary:Accept header
                      Tweak: HTML layout changes, more fine-grained snippet methods)
*/
...
' . ($this->p('query') ? htmlspecialchars($this->p('query')) : "SELECT ?s ?p ?o WHERE {\n  ?s ?p ?o .\n}\nLIMIT10" ) . '
        </textarea>
        ...
        <dl>
          ...
          <dd>
            <select id="output" name="output">
              ...
              <!-- <option value="sql" ' . ($sel == 'sql' ? $sel_code : '') . '>SQL</option> -->
