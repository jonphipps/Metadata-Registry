...
/**
 * Base class that represents a row from the 'schema_has_user' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseSchemaHasUser extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SchemaHasUserPeer::ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== $ts) {
			$this->created_at = $ts;
			$this->modifiedColumns[] = SchemaHasUserPeer::CREATED_AT;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== $ts) {
			$this->updated_at = $ts;
			$this->modifiedColumns[] = SchemaHasUserPeer::UPDATED_AT;
		}
	...
	public function setDeletedAt($v)
	{
		...
		if ($this->deleted_at !== $ts) {
			$this->deleted_at = $ts;
			$this->modifiedColumns[] = SchemaHasUserPeer::DELETED_AT;
		}
	...
	public function setSchemaId($v)
	{
		...
		if ($this->schema_id !== $v || $v === 0) {
			$this->schema_id = $v;
			$this->modifiedColumns[] = SchemaHasUserPeer::SCHEMA_ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v || $v === 0) {
			$this->user_id = $v;
			$this->modifiedColumns[] = SchemaHasUserPeer::USER_ID;
		}
	...
	public function setIsMaintainerFor($v)
	{
		...
		if ($this->is_maintainer_for !== $v || $v === true) {
			...
			$this->modifiedColumns[] = SchemaHasUserPeer::IS_MAINTAINER_FOR;
		}
	...
	public function setIsRegistrarFor($v)
	{
		...
		if ($this->is_registrar_for !== $v || $v === true) {
			...
			$this->modifiedColumns[] = SchemaHasUserPeer::IS_REGISTRAR_FOR;
		}
	...
	public function setIsAdminFor($v)
	{
		...
		if ($this->is_admin_for !== $v || $v === true) {
			$this->is_admin_for = $v;
			$this->modifiedColumns[] = SchemaHasUserPeer::IS_ADMIN_FOR;
		}
	...
	public function setLanguages($v)
	{
		...
		if ($this->languages !== $v) {
			$this->languages = $v;
			$this->modifiedColumns[] = SchemaHasUserPeer::LANGUAGES;
		}
	...
	public function setDefaultLanguage($v)
	{
		...
		if ($this->default_language !== $v || $v === 'en') {
			...
			$this->modifiedColumns[] = SchemaHasUserPeer::DEFAULT_LANGUAGE;
		}
    ...
    foreach (sfMixer::getCallables('BaseSchemaHasUser:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			$con->begin();
			SchemaHasUserPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseSchemaHasUser:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseSchemaHasUser:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(SchemaHasUserPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(SchemaHasUserPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseSchemaHasUser:save:post') as $callable)
    {
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = SchemaHasUserPeer::doInsert($this, $con);
					...
					$affectedRows += SchemaHasUserPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SchemaHasUserPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SchemaHasUserPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SchemaHasUserPeer::ID)) $criteria->add(SchemaHasUserPeer::ID, $this->id);
		if ($this->isColumnModified(SchemaHasUserPeer::CREATED_AT)) $criteria->add(SchemaHasUserPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(SchemaHasUserPeer::UPDATED_AT)) $criteria->add(SchemaHasUserPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(SchemaHasUserPeer::DELETED_AT)) $criteria->add(SchemaHasUserPeer::DELETED_AT, $this->deleted_at);
		if ($this->isColumnModified(SchemaHasUserPeer::SCHEMA_ID)) $criteria->add(SchemaHasUserPeer::SCHEMA_ID, $this->schema_id);
		if ($this->isColumnModified(SchemaHasUserPeer::USER_ID)) $criteria->add(SchemaHasUserPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(SchemaHasUserPeer::IS_MAINTAINER_FOR)) $criteria->add(SchemaHasUserPeer::IS_MAINTAINER_FOR, $this->is_maintainer_for);
		if ($this->isColumnModified(SchemaHasUserPeer::IS_REGISTRAR_FOR)) $criteria->add(SchemaHasUserPeer::IS_REGISTRAR_FOR, $this->is_registrar_for);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(SchemaHasUserPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SchemaHasUser (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SchemaHasUser Clone of current object.
	 * @throws     PropelException
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseSchemaHasUser:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseSchemaHasUser::%s', $method));
    }
