 ...
 */
abstract class BaseRegVocabularyHasUser extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = RegVocabularyHasUserPeer::ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== $ts) {
			$this->created_at = $ts;
			$this->modifiedColumns[] = RegVocabularyHasUserPeer::CREATED_AT;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== $ts) {
			$this->updated_at = $ts;
			$this->modifiedColumns[] = RegVocabularyHasUserPeer::UPDATED_AT;
		}
	...
	public function setDeletedAt($v)
	{
		...
		if ($this->deleted_at !== $ts) {
			$this->deleted_at = $ts;
			$this->modifiedColumns[] = RegVocabularyHasUserPeer::DELETED_AT;
		}
	...
	public function setVocabularyId($v)
	{
		...
		if ($this->vocabulary_id !== $v || $v === 0) {
			...
			$this->modifiedColumns[] = RegVocabularyHasUserPeer::VOCABULARY_ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v || $v === 0) {
			$this->user_id = $v;
			$this->modifiedColumns[] = RegVocabularyHasUserPeer::USER_ID;
		}
	...
	public function setIsMaintainerFor($v)
	{
		...
		if ($this->is_maintainer_for !== $v || $v === true) {
			...
			$this->modifiedColumns[] = RegVocabularyHasUserPeer::IS_MAINTAINER_FOR;
		}
	...
	public function setIsRegistrarFor($v)
	{
		...
		if ($this->is_registrar_for !== $v || $v === true) {
			...
			$this->modifiedColumns[] = RegVocabularyHasUserPeer::IS_REGISTRAR_FOR;
		}
	...
	public function setIsAdminFor($v)
	{
		...
		if ($this->is_admin_for !== $v || $v === true) {
			$this->is_admin_for = $v;
			$this->modifiedColumns[] = RegVocabularyHasUserPeer::IS_ADMIN_FOR;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 9; // 9 = RegVocabularyHasUserPeer::NUM_COLUMNS - RegVocabularyHasUserPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating RegVocabularyHasUser object", $e);
		}
	}
    ...
    foreach (sfMixer::getCallables('BaseRegVocabularyHasUser:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			$con->begin();
			RegVocabularyHasUserPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseRegVocabularyHasUser:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseRegVocabularyHasUser:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(RegVocabularyHasUserPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(RegVocabularyHasUserPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseRegVocabularyHasUser:save:post') as $callable)
    {
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = RegVocabularyHasUserPeer::doInsert($this, $con);
					...
					$affectedRows += RegVocabularyHasUserPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RegVocabularyHasUserPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RegVocabularyHasUserPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = RegVocabularyHasUserPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RegVocabularyHasUserPeer::ID)) $criteria->add(RegVocabularyHasUserPeer::ID, $this->id);
		if ($this->isColumnModified(RegVocabularyHasUserPeer::CREATED_AT)) $criteria->add(RegVocabularyHasUserPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(RegVocabularyHasUserPeer::UPDATED_AT)) $criteria->add(RegVocabularyHasUserPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(RegVocabularyHasUserPeer::DELETED_AT)) $criteria->add(RegVocabularyHasUserPeer::DELETED_AT, $this->deleted_at);
		if ($this->isColumnModified(RegVocabularyHasUserPeer::VOCABULARY_ID)) $criteria->add(RegVocabularyHasUserPeer::VOCABULARY_ID, $this->vocabulary_id);
		if ($this->isColumnModified(RegVocabularyHasUserPeer::USER_ID)) $criteria->add(RegVocabularyHasUserPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(RegVocabularyHasUserPeer::IS_MAINTAINER_FOR)) $criteria->add(RegVocabularyHasUserPeer::IS_MAINTAINER_FOR, $this->is_maintainer_for);
		if ($this->isColumnModified(RegVocabularyHasUserPeer::IS_REGISTRAR_FOR)) $criteria->add(RegVocabularyHasUserPeer::IS_REGISTRAR_FOR, $this->is_registrar_for);
		if ($this->isColumnModified(RegVocabularyHasUserPeer::IS_ADMIN_FOR)) $criteria->add(RegVocabularyHasUserPeer::IS_ADMIN_FOR, $this->is_admin_for);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(RegVocabularyHasUserPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of RegVocabularyHasUser (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     RegVocabularyHasUser Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     RegVocabularyHasUserPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new RegVocabularyHasUserPeer();
		}
		return self::$peer;
	}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseRegVocabularyHasUser:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseRegVocabularyHasUser::%s', $method));
    }
