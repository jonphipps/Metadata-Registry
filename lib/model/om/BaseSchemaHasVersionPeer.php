...
abstract class BaseSchemaHasVersionPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of SchemaHasVersion objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array SchemaHasVersion[]
	 */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'createdAt', 'deletedAt', 'updatedAt', 'createdUserId', 'schemaId', 'timeslice', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::CREATED_AT, self::DELETED_AT, self::UPDATED_AT, self::CREATED_USER_ID, self::SCHEMA_ID, self::TIMESLICE, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'createdAt' => 2, 'deletedAt' => 3, 'updatedAt' => 4, 'createdUserId' => 5, 'schemaId' => 6, 'timeslice' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::CREATED_AT => 2, self::DELETED_AT => 3, self::UPDATED_AT => 4, self::CREATED_USER_ID => 5, self::SCHEMA_ID => 6, self::TIMESLICE => 7, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new SchemaHasVersionMapBuilder();
		}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(SchemaHasVersionPeer::TABLE_NAME);
		...
		if ($con === null) {
			$con = Propel::getConnection(SchemaHasVersionPeer::DATABASE_NAME, Propel::CONNECTION_READ);
		}


    foreach (sfMixer::getCallables('BaseSchemaHasVersionPeer:doCount:doCount') as $callable)
    {
	...
	{
		return SchemaHasVersionPeer::populateObjects(SchemaHasVersionPeer::doSelectStmt($criteria, $con));
	}
	/**
    ...
    foreach (sfMixer::getCallables('BaseSchemaHasVersionPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseSchemaHasVersionPeer', $criteria, $con);
    }
	 ...
	 *
	 * @param      SchemaHasVersion $value A SchemaHasVersion object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(SchemaHasVersion $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A SchemaHasVersion object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof SchemaHasVersion) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or SchemaHasVersion object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     SchemaHasVersion Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = SchemaHasVersionPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = SchemaHasVersionPeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				SchemaHasVersionPeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(SchemaHasVersionPeer::CREATED_USER_ID,), array(UserPeer::ID,), $join_behavior);
	...
	public static function doCountJoinSchema(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(SchemaHasVersionPeer::SCHEMA_ID,), array(SchemaPeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseSchemaHasVersionPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseSchemaHasVersionPeer', $c, $con);
    }
		...
		$startcol = (SchemaHasVersionPeer::NUM_COLUMNS - SchemaHasVersionPeer::NUM_LAZY_LOAD_COLUMNS);
		UserPeer::addSelectColumns($c);

		$c->addJoin(array(SchemaHasVersionPeer::CREATED_USER_ID,), array(UserPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();

		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = SchemaHasVersionPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = SchemaHasVersionPeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://propel.phpdb.org/trac/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				SchemaHasVersionPeer::addInstanceToPool($obj1, $key1);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SchemaHasVersion) to $obj2 (User)
	...
	public static function doSelectJoinSchema(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(SchemaHasVersionPeer::SCHEMA_ID,), array(SchemaPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SchemaHasVersion) to $obj2 (Schema)
				$obj2->addSchemaHasVersion($obj1);
    ...
    foreach (sfMixer::getCallables('BaseSchemaHasVersionPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseSchemaHasVersionPeer', $c, $con);
    }
		...
		SchemaHasVersionPeer::addSelectColumns($c);
		$startcol2 = (SchemaHasVersionPeer::NUM_COLUMNS - SchemaHasVersionPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SchemaHasVersion) to the collection in $obj2 (User)
				$obj2->addSchemaHasVersion($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (SchemaHasVersion) to the collection in $obj3 (Schema)
    ...
    foreach (sfMixer::getCallables('BaseSchemaHasVersionPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseSchemaHasVersionPeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = SchemaHasVersionPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (SchemaHasVersion) to the collection in $obj2 (Schema)
				$obj2->addSchemaHasVersion($obj1);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseSchemaHasVersionPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($con === null) {
			$con = Propel::getConnection(SchemaHasVersionPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
		...
		if ($criteria->containsKey(SchemaHasVersionPeer::ID) && $criteria->keyContainsValue(SchemaHasVersionPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.SchemaHasVersionPeer::ID.')');
		}
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			SchemaHasVersionPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				...
				SchemaHasVersionPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = SchemaHasVersionPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
//
// NOTE: This static code cannot call methods on the SchemaHasVersionPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the SchemaHasVersionPeer class:
//
// Propel::getDatabaseMap(SchemaHasVersionPeer::DATABASE_NAME)->addTableBuilder(SchemaHasVersionPeer::TABLE_NAME, SchemaHasVersionPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseSchemaHasVersionPeer::DATABASE_NAME)->addTableBuilder(BaseSchemaHasVersionPeer::TABLE_NAME, BaseSchemaHasVersionPeer::getMapBuilder());
