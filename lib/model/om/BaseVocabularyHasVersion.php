...
abstract class BaseVocabularyHasVersion extends BaseObject  implements Persistent {
  ...
  const PEER = 'VocabularyHasVersionPeer';
	...
	/**
	 * Initializes internal state of BaseVocabularyHasVersion object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     VocabularyHasVersion The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(VocabularyHasVersionPeer::NAME))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->vocabulary_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = VocabularyHasVersionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseVocabularyHasVersion:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
			...
			VocabularyHasVersionPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	public function setUser(User $v = null)
	{
		...
		if ($v !== null) {
			$v->addVocabularyHasVersion($this);
		}
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->created_user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUser->addVocabularyHasVersions($this);
			 */
		}
		return $this->aUser;
	}
	...
	public function getVocabulary(PropelPDO $con = null)
	{
		if ($this->aVocabulary === null && ($this->vocabulary_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aVocabulary->addVocabularyHasVersions($this);
			 */
		}
