...
abstract class BaseProfilePeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'agentId', 'createdAt', 'updatedAt', 'deletedAt', 'createdBy', 'updatedBy', 'deletedBy', 'childUpdatedAt', 'childUpdatedBy', 'name', 'note', 'uri', 'url', 'baseDomain', 'token', 'community', 'lastUriId', 'statusId', 'language', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::AGENT_ID, self::CREATED_AT, self::UPDATED_AT, self::DELETED_AT, self::CREATED_BY, self::UPDATED_BY, self::DELETED_BY, self::CHILD_UPDATED_AT, self::CHILD_UPDATED_BY, self::NAME, self::NOTE, self::URI, self::URL, self::BASE_DOMAIN, self::TOKEN, self::COMMUNITY, self::LAST_URI_ID, self::STATUS_ID, self::LANGUAGE, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'agentId' => 1, 'createdAt' => 2, 'updatedAt' => 3, 'deletedAt' => 4, 'createdBy' => 5, 'updatedBy' => 6, 'deletedBy' => 7, 'childUpdatedAt' => 8, 'childUpdatedBy' => 9, 'name' => 10, 'note' => 11, 'uri' => 12, 'url' => 13, 'baseDomain' => 14, 'token' => 15, 'community' => 16, 'lastUriId' => 17, 'statusId' => 18, 'language' => 19, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::AGENT_ID => 1, self::CREATED_AT => 2, self::UPDATED_AT => 3, self::DELETED_AT => 4, self::CREATED_BY => 5, self::UPDATED_BY => 6, self::DELETED_BY => 7, self::CHILD_UPDATED_AT => 8, self::CHILD_UPDATED_BY => 9, self::NAME => 10, self::NOTE => 11, self::URI => 12, self::URL => 13, self::BASE_DOMAIN => 14, self::TOKEN => 15, self::COMMUNITY => 16, self::LAST_URI_ID => 17, self::STATUS_ID => 18, self::LANGUAGE => 19, ),
	...
	public static function doCountJoinAgent(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ProfilePeer::AGENT_ID,), array(AgentPeer::ID,), $join_behavior);
	...
	public static function doCountJoinUserRelatedByCreatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ProfilePeer::CREATED_BY,), array(UserPeer::ID,), $join_behavior);
	...
	public static function doCountJoinUserRelatedByUpdatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ProfilePeer::UPDATED_BY,), array(UserPeer::ID,), $join_behavior);
	...
	public static function doCountJoinUserRelatedByDeletedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ProfilePeer::DELETED_BY,), array(UserPeer::ID,), $join_behavior);
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinUserRelatedByChildUpdatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(array(ProfilePeer::CHILD_UPDATED_BY,), array(UserPeer::ID,), $join_behavior);
	...
	public static function doCountJoinStatus(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ProfilePeer::STATUS_ID,), array(StatusPeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseProfilePeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseProfilePeer', $c, $con);
    }
		...
		$c->addJoin(array(ProfilePeer::AGENT_ID,), array(AgentPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Profile) to $obj2 (Agent)
	...
	public static function doSelectJoinUserRelatedByCreatedBy(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(ProfilePeer::CREATED_BY,), array(UserPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinUserRelatedByUpdatedBy(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(ProfilePeer::UPDATED_BY,), array(UserPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Profile) to $obj2 (User)
				$obj2->addProfileRelatedByUpdatedBy($obj1);
	...
	public static function doSelectJoinUserRelatedByDeletedBy(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(ProfilePeer::DELETED_BY,), array(UserPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Profile) to $obj2 (User)
				$obj2->addProfileRelatedByDeletedBy($obj1);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUserRelatedByChildUpdatedBy(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
		...
		$c->addJoin(array(ProfilePeer::CHILD_UPDATED_BY,), array(UserPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Profile) to $obj2 (User)
				$obj2->addProfileRelatedByChildUpdatedBy($obj1);
	...
	public static function doSelectJoinStatus(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(ProfilePeer::STATUS_ID,), array(StatusPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Profile) to $obj2 (Status)
				$obj2->addProfile($obj1);
    ...
    foreach (sfMixer::getCallables('BaseProfilePeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseProfilePeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Profile) to the collection in $obj2 (Agent)
				$obj2->addProfile($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Profile) to the collection in $obj3 (User)
			...
			if ($key4 !== null) {
				...
				// Add the $obj1 (Profile) to the collection in $obj4 (User)
			...
			if ($key5 !== null) {
				...
				// Add the $obj1 (Profile) to the collection in $obj5 (User)
			...
			if ($key6 !== null) {
				...
				// Add the $obj1 (Profile) to the collection in $obj6 (User)
			...
			if ($key7 !== null) {
				...
				// Add the $obj1 (Profile) to the collection in $obj7 (Status)
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptUserRelatedByChildUpdatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
    ...
    foreach (sfMixer::getCallables('BaseProfilePeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseProfilePeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = ProfilePeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Profile) to the collection in $obj6 (Status)
	...
	public static function doSelectJoinAllExceptUserRelatedByCreatedBy(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = ProfilePeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Profile) to the collection in $obj3 (Status)
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptUserRelatedByChildUpdatedBy(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
