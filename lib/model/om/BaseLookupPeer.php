...
abstract class BaseLookupPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'typeId', 'shortValue', 'longValue', 'displayOrder', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TYPE_ID, self::SHORT_VALUE, self::LONG_VALUE, self::DISPLAY_ORDER, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'typeId' => 1, 'shortValue' => 2, 'longValue' => 3, 'displayOrder' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TYPE_ID => 1, self::SHORT_VALUE => 2, self::LONG_VALUE => 3, self::DISPLAY_ORDER => 4, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new LookupMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseLookupPeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseLookupPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseLookupPeer', $criteria, $con);
    }
...
//
// NOTE: This static code cannot call methods on the LookupPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the LookupPeer class:
//
// Propel::getDatabaseMap(LookupPeer::DATABASE_NAME)->addTableBuilder(LookupPeer::TABLE_NAME, LookupPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseLookupPeer::DATABASE_NAME)->addTableBuilder(BaseLookupPeer::TABLE_NAME, BaseLookupPeer::getMapBuilder());
