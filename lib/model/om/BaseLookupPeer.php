...
// actual class may be a subclass -- as returned by LookupPeer::getOMClass()
include_once 'model/Lookup.php';

/**
 * Base static class for performing query and update operations on the 'reg_lookup' table.
 *
 * 
 *
 * @package model.om
...
abstract class BaseLookupPeer {
	...
	/** the column name for the SHORT_VALUE field */
	const SHORT_VALUE = 'reg_lookup.SHORT_VALUE';

	/** the column name for the LONG_VALUE field */
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'TypeId', 'ShortValue', 'LongValue', ),
		BasePeer::TYPE_COLNAME => array (LookupPeer::ID, LookupPeer::TYPE_ID, LookupPeer::SHORT_VALUE, LookupPeer::LONG_VALUE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'type_id', 'short_value', 'long_value', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'TypeId' => 1, 'ShortValue' => 2, 'LongValue' => 3, ),
		BasePeer::TYPE_COLNAME => array (LookupPeer::ID => 0, LookupPeer::TYPE_ID => 1, LookupPeer::SHORT_VALUE => 2, LookupPeer::LONG_VALUE => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'type_id' => 1, 'short_value' => 2, 'long_value' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function populateObjects(ResultSet $rs)
	{
		...
		while($rs->next()) {
			...
			$cls = Propel::import(LookupPeer::getOMClass($rs, 1));
			$obj = new $cls();
			$obj->hydrate($rs);
			$results[] = $obj;
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(LookupPeer::ID); // remove pkey col since this table uses auto-increment
	...
	/**
	 * Method to DELETE all rows from the reg_lookup table.
	 *
	 * @return int The number of affected rows (if supported by underlying database driver).
	 */
