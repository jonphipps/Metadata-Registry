 ...
 */
abstract class BaseRegVocabularyHasVersion extends BaseObject  implements Persistent {
	 ...
	 * @var        RegVocabularyHasVersionPeer
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = RegVocabularyHasVersionPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v || $v === '') {
			$this->name = $v;
			$this->modifiedColumns[] = RegVocabularyHasVersionPeer::NAME;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== $ts) {
			$this->created_at = $ts;
			$this->modifiedColumns[] = RegVocabularyHasVersionPeer::CREATED_AT;
		}
	...
	public function setDeletedAt($v)
	{
		...
		if ($this->deleted_at !== $ts) {
			$this->deleted_at = $ts;
			$this->modifiedColumns[] = RegVocabularyHasVersionPeer::DELETED_AT;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== $ts) {
			$this->updated_at = $ts;
			$this->modifiedColumns[] = RegVocabularyHasVersionPeer::UPDATED_AT;
		}
	...
	public function setCreatedUserId($v)
	{
		...
		if ($this->created_user_id !== $v) {
			...
			$this->modifiedColumns[] = RegVocabularyHasVersionPeer::CREATED_USER_ID;
		}
	...
	public function setVocabularyId($v)
	{
		...
		if ($this->vocabulary_id !== $v) {
			...
			$this->modifiedColumns[] = RegVocabularyHasVersionPeer::VOCABULARY_ID;
		}
	...
	public function setTimeslice($v)
	{
		...
		if ($this->timeslice !== $ts) {
			$this->timeslice = $ts;
			$this->modifiedColumns[] = RegVocabularyHasVersionPeer::TIMESLICE;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 8; // 8 = RegVocabularyHasVersionPeer::NUM_COLUMNS - RegVocabularyHasVersionPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating RegVocabularyHasVersion object", $e);
		}
	}
    ...
    foreach (sfMixer::getCallables('BaseRegVocabularyHasVersion:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			$con->begin();
			RegVocabularyHasVersionPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseRegVocabularyHasVersion:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseRegVocabularyHasVersion:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(RegVocabularyHasVersionPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(RegVocabularyHasVersionPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseRegVocabularyHasVersion:save:post') as $callable)
    {
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = RegVocabularyHasVersionPeer::doInsert($this, $con);
					...
					$affectedRows += RegVocabularyHasVersionPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RegVocabularyHasVersionPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RegVocabularyHasVersionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = RegVocabularyHasVersionPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RegVocabularyHasVersionPeer::ID)) $criteria->add(RegVocabularyHasVersionPeer::ID, $this->id);
		if ($this->isColumnModified(RegVocabularyHasVersionPeer::NAME)) $criteria->add(RegVocabularyHasVersionPeer::NAME, $this->name);
		if ($this->isColumnModified(RegVocabularyHasVersionPeer::CREATED_AT)) $criteria->add(RegVocabularyHasVersionPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(RegVocabularyHasVersionPeer::DELETED_AT)) $criteria->add(RegVocabularyHasVersionPeer::DELETED_AT, $this->deleted_at);
		if ($this->isColumnModified(RegVocabularyHasVersionPeer::UPDATED_AT)) $criteria->add(RegVocabularyHasVersionPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(RegVocabularyHasVersionPeer::CREATED_USER_ID)) $criteria->add(RegVocabularyHasVersionPeer::CREATED_USER_ID, $this->created_user_id);
		if ($this->isColumnModified(RegVocabularyHasVersionPeer::VOCABULARY_ID)) $criteria->add(RegVocabularyHasVersionPeer::VOCABULARY_ID, $this->vocabulary_id);
		if ($this->isColumnModified(RegVocabularyHasVersionPeer::TIMESLICE)) $criteria->add(RegVocabularyHasVersionPeer::TIMESLICE, $this->timeslice);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(RegVocabularyHasVersionPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of RegVocabularyHasVersion (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     RegVocabularyHasVersion Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     RegVocabularyHasVersionPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new RegVocabularyHasVersionPeer();
		}
		return self::$peer;
	}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseRegVocabularyHasVersion:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseRegVocabularyHasVersion::%s', $method));
    }
