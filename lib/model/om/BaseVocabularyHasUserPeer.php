...
abstract class BaseVocabularyHasUserPeer {
	...
	public static function doCountJoinUsers(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(VocabularyHasUserPeer::USER_ID, UsersPeer::ID);
	...
	/**
	 * Selects a collection of VocabularyHasUser objects pre-filled with their Users objects.
	 *
	 * @return array Array of VocabularyHasUser objects.
	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	public static function doSelectJoinUsers(Criteria $c, $con = null)
	{
		...
		$c->addJoin(VocabularyHasUserPeer::USER_ID, UsersPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
        ...
        $c->addJoin(VocabularyHasUserPeer::USER_ID, UsersPeer::alias('a2', UsersPeer::ID));
	...
	/**
	 * Selects a collection of VocabularyHasUser objects pre-filled with all related objects except Users.
	 *
	 * @return array Array of VocabularyHasUser objects.
	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
