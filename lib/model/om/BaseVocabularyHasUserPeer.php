...
abstract class BaseVocabularyHasUserPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of VocabularyHasUser objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array VocabularyHasUser[]
	 */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'createdAt', 'updatedAt', 'deletedAt', 'vocabularyId', 'userId', 'isMaintainerFor', 'isRegistrarFor', 'isAdminFor', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CREATED_AT, self::UPDATED_AT, self::DELETED_AT, self::VOCABULARY_ID, self::USER_ID, self::IS_MAINTAINER_FOR, self::IS_REGISTRAR_FOR, self::IS_ADMIN_FOR, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'createdAt' => 1, 'updatedAt' => 2, 'deletedAt' => 3, 'vocabularyId' => 4, 'userId' => 5, 'isMaintainerFor' => 6, 'isRegistrarFor' => 7, 'isAdminFor' => 8, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CREATED_AT => 1, self::UPDATED_AT => 2, self::DELETED_AT => 3, self::VOCABULARY_ID => 4, self::USER_ID => 5, self::IS_MAINTAINER_FOR => 6, self::IS_REGISTRAR_FOR => 7, self::IS_ADMIN_FOR => 8, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new VocabularyHasUserMapBuilder();
		}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(VocabularyHasUserPeer::TABLE_NAME);
		...
		if ($con === null) {
			$con = Propel::getConnection(VocabularyHasUserPeer::DATABASE_NAME, Propel::CONNECTION_READ);
		}


    foreach (sfMixer::getCallables('BaseVocabularyHasUserPeer:doCount:doCount') as $callable)
    {
	...
	{
		return VocabularyHasUserPeer::populateObjects(VocabularyHasUserPeer::doSelectStmt($criteria, $con));
	}
	/**
    ...
    foreach (sfMixer::getCallables('BaseVocabularyHasUserPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseVocabularyHasUserPeer', $criteria, $con);
    }
	 ...
	 *
	 * @param      VocabularyHasUser $value A VocabularyHasUser object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(VocabularyHasUser $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A VocabularyHasUser object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof VocabularyHasUser) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or VocabularyHasUser object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     VocabularyHasUser Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = VocabularyHasUserPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = VocabularyHasUserPeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				VocabularyHasUserPeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
	...
	public static function doCountJoinVocabulary(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(VocabularyHasUserPeer::VOCABULARY_ID,), array(VocabularyPeer::ID,), $join_behavior);
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(VocabularyHasUserPeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseVocabularyHasUserPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseVocabularyHasUserPeer', $c, $con);
    }
		...
		$startcol = (VocabularyHasUserPeer::NUM_COLUMNS - VocabularyHasUserPeer::NUM_LAZY_LOAD_COLUMNS);
		VocabularyPeer::addSelectColumns($c);

		$c->addJoin(array(VocabularyHasUserPeer::VOCABULARY_ID,), array(VocabularyPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();

		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = VocabularyHasUserPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = VocabularyHasUserPeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://propel.phpdb.org/trac/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				VocabularyHasUserPeer::addInstanceToPool($obj1, $key1);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (VocabularyHasUser) to $obj2 (Vocabulary)
	...
	public static function doSelectJoinUser(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(VocabularyHasUserPeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (VocabularyHasUser) to $obj2 (User)
				$obj2->addVocabularyHasUser($obj1);
    ...
    foreach (sfMixer::getCallables('BaseVocabularyHasUserPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseVocabularyHasUserPeer', $c, $con);
    }
		...
		VocabularyHasUserPeer::addSelectColumns($c);
		$startcol2 = (VocabularyHasUserPeer::NUM_COLUMNS - VocabularyHasUserPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (VocabularyHasUser) to the collection in $obj2 (Vocabulary)
				$obj2->addVocabularyHasUser($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (VocabularyHasUser) to the collection in $obj3 (User)
    ...
    foreach (sfMixer::getCallables('BaseVocabularyHasUserPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseVocabularyHasUserPeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = VocabularyHasUserPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (VocabularyHasUser) to the collection in $obj2 (User)
				$obj2->addVocabularyHasUser($obj1);
  ...
  {
    return array(array('vocabulary_id', 'user_id'), array('user_id', 'vocabulary_id'));
  }
	/**
    ...
    foreach (sfMixer::getCallables('BaseVocabularyHasUserPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($con === null) {
			$con = Propel::getConnection(VocabularyHasUserPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
		...
		if ($criteria->containsKey(VocabularyHasUserPeer::ID) && $criteria->keyContainsValue(VocabularyHasUserPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.VocabularyHasUserPeer::ID.')');
		}
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			VocabularyHasUserPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				...
				VocabularyHasUserPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = VocabularyHasUserPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
//
// NOTE: This static code cannot call methods on the VocabularyHasUserPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the VocabularyHasUserPeer class:
//
// Propel::getDatabaseMap(VocabularyHasUserPeer::DATABASE_NAME)->addTableBuilder(VocabularyHasUserPeer::TABLE_NAME, VocabularyHasUserPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseVocabularyHasUserPeer::DATABASE_NAME)->addTableBuilder(BaseVocabularyHasUserPeer::TABLE_NAME, BaseVocabularyHasUserPeer::getMapBuilder());
