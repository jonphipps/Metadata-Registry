...
abstract class BaseAgentPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of Agent objects.
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'createdAt', 'lastUpdated', 'deletedAt', 'orgEmail', 'orgName', 'indAffiliation', 'indRole', 'address1', 'address2', 'city', 'state', 'postalCode', 'country', 'phone', 'webAddress', 'type', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CREATED_AT, self::LAST_UPDATED, self::DELETED_AT, self::ORG_EMAIL, self::ORG_NAME, self::IND_AFFILIATION, self::IND_ROLE, self::ADDRESS1, self::ADDRESS2, self::CITY, self::STATE, self::POSTAL_CODE, self::COUNTRY, self::PHONE, self::WEB_ADDRESS, self::TYPE, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'createdAt' => 1, 'lastUpdated' => 2, 'deletedAt' => 3, 'orgEmail' => 4, 'orgName' => 5, 'indAffiliation' => 6, 'indRole' => 7, 'address1' => 8, 'address2' => 9, 'city' => 10, 'state' => 11, 'postalCode' => 12, 'country' => 13, 'phone' => 14, 'webAddress' => 15, 'type' => 16, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CREATED_AT => 1, self::LAST_UPDATED => 2, self::DELETED_AT => 3, self::ORG_EMAIL => 4, self::ORG_NAME => 5, self::IND_AFFILIATION => 6, self::IND_ROLE => 7, self::ADDRESS1 => 8, self::ADDRESS2 => 9, self::CITY => 10, self::STATE => 11, self::POSTAL_CODE => 12, self::COUNTRY => 13, self::PHONE => 14, self::WEB_ADDRESS => 15, self::TYPE => 16, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new AgentMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseAgentPeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseAgentPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseAgentPeer', $criteria, $con);
    }
	 ...
	 *
	 * @param      Agent $value A Agent object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Agent $obj, $key = null)
	{
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += AgentPeer::doOnDeleteCascade(new Criteria(AgentPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += AgentPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = AgentPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {
			...
			$c->add(AgentHasUserPeer::AGENT_ID, $obj->getId());
...
//
// NOTE: This static code cannot call methods on the AgentPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the AgentPeer class:
//
// Propel::getDatabaseMap(AgentPeer::DATABASE_NAME)->addTableBuilder(AgentPeer::TABLE_NAME, AgentPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseAgentPeer::DATABASE_NAME)->addTableBuilder(BaseAgentPeer::TABLE_NAME, BaseAgentPeer::getMapBuilder());
