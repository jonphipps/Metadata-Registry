...
abstract class BaseAgentHasUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'CreatedAt', 'UpdatedAt', 'DeletedAt', 'UserId', 'AgentId', 'IsRegistrarFor', 'IsAdminFor', ),
		BasePeer::TYPE_COLNAME => array (AgentHasUserPeer::ID, AgentHasUserPeer::CREATED_AT, AgentHasUserPeer::UPDATED_AT, AgentHasUserPeer::DELETED_AT, AgentHasUserPeer::USER_ID, AgentHasUserPeer::AGENT_ID, AgentHasUserPeer::IS_REGISTRAR_FOR, AgentHasUserPeer::IS_ADMIN_FOR, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'created_at', 'updated_at', 'deleted_at', 'user_id', 'agent_id', 'is_registrar_for', 'is_admin_for', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CreatedAt' => 1, 'UpdatedAt' => 2, 'DeletedAt' => 3, 'UserId' => 4, 'AgentId' => 5, 'IsRegistrarFor' => 6, 'IsAdminFor' => 7, ),
		BasePeer::TYPE_COLNAME => array (AgentHasUserPeer::ID => 0, AgentHasUserPeer::CREATED_AT => 1, AgentHasUserPeer::UPDATED_AT => 2, AgentHasUserPeer::DELETED_AT => 3, AgentHasUserPeer::USER_ID => 4, AgentHasUserPeer::AGENT_ID => 5, AgentHasUserPeer::IS_REGISTRAR_FOR => 6, AgentHasUserPeer::IS_ADMIN_FOR => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'created_at' => 1, 'updated_at' => 2, 'deleted_at' => 3, 'user_id' => 4, 'agent_id' => 5, 'is_registrar_for' => 6, 'is_admin_for' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
