...
abstract class BaseAgentHasUserPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of AgentHasUser objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array AgentHasUser[]
	 */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'updatedAt', 'deletedAt', 'createdAt', 'userId', 'agentId', 'isRegistrarFor', 'isAdminFor', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::UPDATED_AT, self::DELETED_AT, self::CREATED_AT, self::USER_ID, self::AGENT_ID, self::IS_REGISTRAR_FOR, self::IS_ADMIN_FOR, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'updatedAt' => 1, 'deletedAt' => 2, 'createdAt' => 3, 'userId' => 4, 'agentId' => 5, 'isRegistrarFor' => 6, 'isAdminFor' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::UPDATED_AT => 1, self::DELETED_AT => 2, self::CREATED_AT => 3, self::USER_ID => 4, self::AGENT_ID => 5, self::IS_REGISTRAR_FOR => 6, self::IS_ADMIN_FOR => 7, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new AgentHasUserMapBuilder();
		}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(AgentHasUserPeer::TABLE_NAME);
		...
		if ($con === null) {
			$con = Propel::getConnection(AgentHasUserPeer::DATABASE_NAME, Propel::CONNECTION_READ);
		}


    foreach (sfMixer::getCallables('BaseAgentHasUserPeer:doCount:doCount') as $callable)
    {
	...
	{
		return AgentHasUserPeer::populateObjects(AgentHasUserPeer::doSelectStmt($criteria, $con));
	}
	/**
    ...
    foreach (sfMixer::getCallables('BaseAgentHasUserPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseAgentHasUserPeer', $criteria, $con);
    }
	 ...
	 *
	 * @param      AgentHasUser $value A AgentHasUser object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(AgentHasUser $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A AgentHasUser object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof AgentHasUser) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or AgentHasUser object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     AgentHasUser Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = AgentHasUserPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = AgentHasUserPeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				AgentHasUserPeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(AgentHasUserPeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
	...
	public static function doCountJoinAgent(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(AgentHasUserPeer::AGENT_ID,), array(AgentPeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseAgentHasUserPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseAgentHasUserPeer', $c, $con);
    }
		...
		$startcol = (AgentHasUserPeer::NUM_COLUMNS - AgentHasUserPeer::NUM_LAZY_LOAD_COLUMNS);
		UserPeer::addSelectColumns($c);

		$c->addJoin(array(AgentHasUserPeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();

		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = AgentHasUserPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = AgentHasUserPeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://propel.phpdb.org/trac/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				AgentHasUserPeer::addInstanceToPool($obj1, $key1);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (AgentHasUser) to $obj2 (User)
	...
	public static function doSelectJoinAgent(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(AgentHasUserPeer::AGENT_ID,), array(AgentPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (AgentHasUser) to $obj2 (Agent)
				$obj2->addAgentHasUser($obj1);
    ...
    foreach (sfMixer::getCallables('BaseAgentHasUserPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseAgentHasUserPeer', $c, $con);
    }
		...
		AgentHasUserPeer::addSelectColumns($c);
		$startcol2 = (AgentHasUserPeer::NUM_COLUMNS - AgentHasUserPeer::NUM_LAZY_LOAD_COLUMNS);

		UserPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + (UserPeer::NUM_COLUMNS - UserPeer::NUM_LAZY_LOAD_COLUMNS);

		AgentPeer::addSelectColumns($c);
		$startcol4 = $startcol3 + (AgentPeer::NUM_COLUMNS - AgentPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (AgentHasUser) to the collection in $obj2 (User)
				$obj2->addAgentHasUser($obj1);
			} // if joined row not null

			// Add objects for joined Agent rows

			$key3 = AgentPeer::getPrimaryKeyHashFromRow($row, $startcol3);
			if ($key3 !== null) {
				$obj3 = AgentPeer::getInstanceFromPool($key3);
				if (!$obj3) {
					...
					AgentPeer::addInstanceToPool($obj3, $key3);
				} // if obj3 loaded

				// Add the $obj1 (AgentHasUser) to the collection in $obj3 (Agent)
    ...
    foreach (sfMixer::getCallables('BaseAgentHasUserPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseAgentHasUserPeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = AgentHasUserPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (AgentHasUser) to the collection in $obj2 (Agent)
				$obj2->addAgentHasUser($obj1);
  ...
  {
    return array(array('user_id', 'agent_id'), array('agent_id', 'user_id'));
  }
	/**
    ...
    foreach (sfMixer::getCallables('BaseAgentHasUserPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($con === null) {
			$con = Propel::getConnection(AgentHasUserPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
		...
		if ($criteria->containsKey(AgentHasUserPeer::ID) && $criteria->keyContainsValue(AgentHasUserPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.AgentHasUserPeer::ID.')');
		}
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			AgentHasUserPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				...
				AgentHasUserPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = AgentHasUserPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
//
// NOTE: This static code cannot call methods on the AgentHasUserPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the AgentHasUserPeer class:
//
// Propel::getDatabaseMap(AgentHasUserPeer::DATABASE_NAME)->addTableBuilder(AgentHasUserPeer::TABLE_NAME, AgentHasUserPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseAgentHasUserPeer::DATABASE_NAME)->addTableBuilder(BaseAgentHasUserPeer::TABLE_NAME, BaseAgentHasUserPeer::getMapBuilder());
