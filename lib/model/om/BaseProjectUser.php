...
abstract class BaseProjectUser extends BaseObject  implements Persistent {
	...
	public function setIsRegistrarFor($v)
	{
		...
		if ($this->is_registrar_for !== $v || $v === true) {
			...
			$this->modifiedColumns[] = ProjectUserPeer::IS_REGISTRAR_FOR;
		}
	...
	public function setIsAdminFor($v)
	{
		...
		if ($this->is_admin_for !== $v || $v === true) {
			$this->is_admin_for = $v;
			$this->modifiedColumns[] = ProjectUserPeer::IS_ADMIN_FOR;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 8; // 8 = ProjectUserPeer::NUM_COLUMNS - ProjectUserPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProjectUserPeer::IS_REGISTRAR_FOR)) $criteria->add(ProjectUserPeer::IS_REGISTRAR_FOR, $this->is_registrar_for);
		if ($this->isColumnModified(ProjectUserPeer::IS_ADMIN_FOR)) $criteria->add(ProjectUserPeer::IS_ADMIN_FOR, $this->is_admin_for);
