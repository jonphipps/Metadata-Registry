...
abstract class BaseRegStatus extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = RegStatusPeer::ID;
		}
	...
	public function setDisplayOrder($v)
	{
		...
		if ($this->display_order !== $v) {
			...
			$this->modifiedColumns[] = RegStatusPeer::DISPLAY_ORDER;
		}
	...
	public function setDisplayName($v)
	{
		...
		if ($this->display_name !== $v) {
			$this->display_name = $v;
			$this->modifiedColumns[] = RegStatusPeer::DISPLAY_NAME;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating RegStatus object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			RegStatusPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = RegStatusPeer::doInsert($this, $con);
					$affectedRows += 1; 
					...
					$affectedRows += RegStatusPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RegStatusPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RegStatusPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = RegStatusPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RegStatusPeer::ID)) $criteria->add(RegStatusPeer::ID, $this->id);
		if ($this->isColumnModified(RegStatusPeer::DISPLAY_ORDER)) $criteria->add(RegStatusPeer::DISPLAY_ORDER, $this->display_order);
		if ($this->isColumnModified(RegStatusPeer::DISPLAY_NAME)) $criteria->add(RegStatusPeer::DISPLAY_NAME, $this->display_name);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(RegStatusPeer::ID, $this->id);
