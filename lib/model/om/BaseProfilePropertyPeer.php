...
abstract class BaseProfilePropertyPeer {
	...
	/** the column name for the NAMESPACE field */
	const NAMESPACE = 'profile_property.NAMESPACE';
	...
	public static function addSelectColumns(Criteria $criteria, $tableAlias = null)
	{
        ...
        $criteria->addSelectColumn(($tableAlias) ? ProfilePropertyPeer::alias($tableAlias, ProfilePropertyPeer::NAMESPACE) : ProfilePropertyPeer::NAMESPACE);
