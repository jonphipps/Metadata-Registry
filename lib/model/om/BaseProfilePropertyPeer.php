...
abstract class BaseProfilePropertyPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'CreatedAt', 'UpdatedAt', 'DeletedAt', 'CreatedBy', 'UpdatedBy', 'DeletedBy', 'ProfileId', 'Name', 'Label', 'Definition', 'Comment', 'Type', 'Uri', 'StatusId', 'Language', 'Note', 'DisplayOrder', 'PicklistOrder', 'Examples', 'IsRequired', 'IsReciprocal', 'IsSingleton', 'IsInPicklist', 'InverseProfilePropertyId', 'SchemaPropertyId', 'SchemaId', 'IsInClassPicklist', 'IsInPropertyPicklist', 'IsInRdf', 'IsInXsd', 'IsAttribute', 'HasLanguage', 'IsObjectProp', ),
