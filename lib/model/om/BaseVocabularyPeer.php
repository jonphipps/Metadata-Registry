...
abstract class BaseVocabularyPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'AgentId', 'CreatedAt', 'UpdatedAt', 'DeletedAt', 'CreatedUserId', 'UpdatedUserId', 'DeletedUserId', 'ChildUpdatedAt', 'ChildUpdatedUserId', 'Name', 'Note', 'Uri', 'Url', 'BaseDomain', 'Token', 'Community', 'LastUriId', 'StatusId', 'Language', 'Languages', 'ProfileId', 'NsType', 'Prefixes', 'Repo', 'Prefix', ),
		BasePeer::TYPE_COLNAME => array (VocabularyPeer::ID, VocabularyPeer::AGENT_ID, VocabularyPeer::CREATED_AT, VocabularyPeer::UPDATED_AT, VocabularyPeer::DELETED_AT, VocabularyPeer::CREATED_USER_ID, VocabularyPeer::UPDATED_USER_ID, VocabularyPeer::DELETED_USER_ID, VocabularyPeer::CHILD_UPDATED_AT, VocabularyPeer::CHILD_UPDATED_USER_ID, VocabularyPeer::NAME, VocabularyPeer::NOTE, VocabularyPeer::URI, VocabularyPeer::URL, VocabularyPeer::BASE_DOMAIN, VocabularyPeer::TOKEN, VocabularyPeer::COMMUNITY, VocabularyPeer::LAST_URI_ID, VocabularyPeer::STATUS_ID, VocabularyPeer::LANGUAGE, VocabularyPeer::LANGUAGES, VocabularyPeer::PROFILE_ID, VocabularyPeer::NS_TYPE, VocabularyPeer::PREFIXES, VocabularyPeer::REPO, VocabularyPeer::PREFIX, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'agent_id', 'created_at', 'updated_at', 'deleted_at', 'created_user_id', 'updated_user_id', 'deleted_user_id', 'child_updated_at', 'child_updated_user_id', 'name', 'note', 'uri', 'url', 'base_domain', 'token', 'community', 'last_uri_id', 'status_id', 'language', 'languages', 'profile_id', 'ns_type', 'prefixes', 'repo', 'prefix', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'AgentId' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, 'DeletedAt' => 4, 'CreatedUserId' => 5, 'UpdatedUserId' => 6, 'DeletedUserId' => 7, 'ChildUpdatedAt' => 8, 'ChildUpdatedUserId' => 9, 'Name' => 10, 'Note' => 11, 'Uri' => 12, 'Url' => 13, 'BaseDomain' => 14, 'Token' => 15, 'Community' => 16, 'LastUriId' => 17, 'StatusId' => 18, 'Language' => 19, 'Languages' => 20, 'ProfileId' => 21, 'NsType' => 22, 'Prefixes' => 23, 'Repo' => 24, 'Prefix' => 25, ),
		BasePeer::TYPE_COLNAME => array (VocabularyPeer::ID => 0, VocabularyPeer::AGENT_ID => 1, VocabularyPeer::CREATED_AT => 2, VocabularyPeer::UPDATED_AT => 3, VocabularyPeer::DELETED_AT => 4, VocabularyPeer::CREATED_USER_ID => 5, VocabularyPeer::UPDATED_USER_ID => 6, VocabularyPeer::DELETED_USER_ID => 7, VocabularyPeer::CHILD_UPDATED_AT => 8, VocabularyPeer::CHILD_UPDATED_USER_ID => 9, VocabularyPeer::NAME => 10, VocabularyPeer::NOTE => 11, VocabularyPeer::URI => 12, VocabularyPeer::URL => 13, VocabularyPeer::BASE_DOMAIN => 14, VocabularyPeer::TOKEN => 15, VocabularyPeer::COMMUNITY => 16, VocabularyPeer::LAST_URI_ID => 17, VocabularyPeer::STATUS_ID => 18, VocabularyPeer::LANGUAGE => 19, VocabularyPeer::LANGUAGES => 20, VocabularyPeer::PROFILE_ID => 21, VocabularyPeer::NS_TYPE => 22, VocabularyPeer::PREFIXES => 23, VocabularyPeer::REPO => 24, VocabularyPeer::PREFIX => 25, ),
	...
	public static function doCountJoinUserRelatedByDeletedUserId(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(VocabularyPeer::DELETED_USER_ID, UserPeer::ID);
	...
	public static function doSelectJoinUserRelatedByDeletedUserId(Criteria $c, $con = null)
	{
		...
		$c->addJoin(VocabularyPeer::DELETED_USER_ID, UserPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj5->getPrimaryKey() === $obj5->getPrimaryKey()) {
					$newObject = false;
					$temp_obj5->addVocabularyRelatedByDeletedUserId($obj1); // CHECKME
					break;
				}
			}

			if ($newObject) {
				$obj5->initVocabularysRelatedByDeletedUserId();
				$obj5->addVocabularyRelatedByDeletedUserId($obj1);
			}
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj6 = $temp_obj1->getUserRelatedByChildUpdatedUserId(); // CHECKME
				if ($temp_obj6->getPrimaryKey() === $obj6->getPrimaryKey()) {
					$newObject = false;
					$temp_obj6->addVocabularyRelatedByChildUpdatedUserId($obj1); // CHECKME
					break;
				}
			}

			if ($newObject) {
				$obj6->initVocabularysRelatedByChildUpdatedUserId();
				$obj6->addVocabularyRelatedByChildUpdatedUserId($obj1);
			}
	...
	/**
	 * Selects a collection of Vocabulary objects pre-filled with all related objects except UserRelatedByDeletedUserId.
	 *
	 * @return array Array of Vocabulary objects.
	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	public static function doSelectJoinAllExceptStatus(Criteria $c, $con = null)
	{
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj5->getPrimaryKey() === $obj5->getPrimaryKey()) {
					$newObject = false;
					$temp_obj5->addVocabularyRelatedByDeletedUserId($obj1);
					break;
				}
			}
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj6->getPrimaryKey() === $obj6->getPrimaryKey()) {
					$newObject = false;
					$temp_obj6->addVocabularyRelatedByChildUpdatedUserId($obj1);
					break;
				}
			}
