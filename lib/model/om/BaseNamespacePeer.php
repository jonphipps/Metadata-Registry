...
abstract class BaseNamespacePeer {
	...
	/**
	 * An identiy map to hold any loaded instances of Namespace objects.
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'schemaId', 'createdAt', 'deletedAt', 'createdUserId', 'updatedUserId', 'token', 'note', 'uri', 'schemaLocation', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::SCHEMA_ID, self::CREATED_AT, self::DELETED_AT, self::CREATED_USER_ID, self::UPDATED_USER_ID, self::TOKEN, self::NOTE, self::URI, self::SCHEMA_LOCATION, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'schemaId' => 1, 'createdAt' => 2, 'deletedAt' => 3, 'createdUserId' => 4, 'updatedUserId' => 5, 'token' => 6, 'note' => 7, 'uri' => 8, 'schemaLocation' => 9, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::SCHEMA_ID => 1, self::CREATED_AT => 2, self::DELETED_AT => 3, self::CREATED_USER_ID => 4, self::UPDATED_USER_ID => 5, self::TOKEN => 6, self::NOTE => 7, self::URI => 8, self::SCHEMA_LOCATION => 9, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new NamespaceMapBuilder();
		}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(NamespacePeer::TABLE_NAME);
		...
		if ($con === null) {
			$con = Propel::getConnection(NamespacePeer::DATABASE_NAME, Propel::CONNECTION_READ);
		}


    foreach (sfMixer::getCallables('BaseNamespacePeer:doCount:doCount') as $callable)
    {
	...
	{
		return NamespacePeer::populateObjects(NamespacePeer::doSelectStmt($criteria, $con));
	}
	/**
    ...
    foreach (sfMixer::getCallables('BaseNamespacePeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseNamespacePeer', $criteria, $con);
    }
	 ...
	 *
	 * @param      Namespace $value A Namespace object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Namespace $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A Namespace object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Namespace) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Namespace object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     Namespace Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = NamespacePeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = NamespacePeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				NamespacePeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
	...
	public static function doCountJoinSchema(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(NamespacePeer::SCHEMA_ID,), array(SchemaPeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseNamespacePeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseNamespacePeer', $c, $con);
    }
		...
		$startcol = (NamespacePeer::NUM_COLUMNS - NamespacePeer::NUM_LAZY_LOAD_COLUMNS);
		SchemaPeer::addSelectColumns($c);

		$c->addJoin(array(NamespacePeer::SCHEMA_ID,), array(SchemaPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();

		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = NamespacePeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = NamespacePeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://propel.phpdb.org/trac/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				NamespacePeer::addInstanceToPool($obj1, $key1);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Namespace) to $obj2 (Schema)
    ...
    foreach (sfMixer::getCallables('BaseNamespacePeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseNamespacePeer', $c, $con);
    }
		...
		NamespacePeer::addSelectColumns($c);
		$startcol2 = (NamespacePeer::NUM_COLUMNS - NamespacePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Namespace) to the collection in $obj2 (Schema)
				$obj2->addNamespace($obj1);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseNamespacePeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($con === null) {
			$con = Propel::getConnection(NamespacePeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
		...
		if ($criteria->containsKey(NamespacePeer::ID) && $criteria->keyContainsValue(NamespacePeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.NamespacePeer::ID.')');
		}
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			NamespacePeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				...
				NamespacePeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = NamespacePeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
//
// NOTE: This static code cannot call methods on the NamespacePeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the NamespacePeer class:
//
// Propel::getDatabaseMap(NamespacePeer::DATABASE_NAME)->addTableBuilder(NamespacePeer::TABLE_NAME, NamespacePeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseNamespacePeer::DATABASE_NAME)->addTableBuilder(BaseNamespacePeer::TABLE_NAME, BaseNamespacePeer::getMapBuilder());
