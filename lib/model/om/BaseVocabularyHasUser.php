...
abstract class BaseVocabularyHasUser extends BaseObject  implements Persistent {
  ...
  const PEER = 'VocabularyHasUserPeer';
	...
	/**
	 * Initializes internal state of BaseVocabularyHasUser object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     VocabularyHasUser The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(VocabularyHasUserPeer::VOCABULARY_ID,VocabularyHasUserPeer::USER_ID,VocabularyHasUserPeer::IS_MAINTAINER_FOR,VocabularyHasUserPeer::IS_REGISTRAR_FOR,VocabularyHasUserPeer::IS_ADMIN_FOR))) {
				return false;
			}

			if ($this->vocabulary_id !== 0) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->vocabulary_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = VocabularyHasUserPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseVocabularyHasUser:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
			...
			VocabularyHasUserPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	public function getVocabulary(PropelPDO $con = null)
	{
		if ($this->aVocabulary === null && ($this->vocabulary_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aVocabulary->addVocabularyHasUsers($this);
			 */
		}
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUser->addVocabularyHasUsers($this);
			 */
		}
		return $this->aUser;
	}
