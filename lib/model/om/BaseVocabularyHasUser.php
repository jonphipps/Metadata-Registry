...
include_once 'model/VocabularyHasUserPeer.php';
...
abstract class BaseVocabularyHasUser extends BaseObject  implements Persistent {
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 4; // 4 = VocabularyHasUserPeer::NUM_COLUMNS - VocabularyHasUserPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setVocabularyId(''); // this is a pkey column, so set to default value
