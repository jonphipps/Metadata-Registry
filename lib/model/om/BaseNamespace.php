...
abstract class BaseNamespace extends BaseObject  implements Persistent {
  ...
  const PEER = 'NamespacePeer';
	...
	/**
	 * Initializes internal state of BaseNamespace object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Namespace The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(NamespacePeer::SCHEMA_ID,NamespacePeer::TOKEN,NamespacePeer::URI))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->uri = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->schema_location = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->resetModified();
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = NamespacePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseNamespace:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
			...
			NamespacePeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	public function getSchema(PropelPDO $con = null)
	{
		if ($this->aSchema === null && ($this->schema_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aSchema->addNamespaces($this);
			 */
		}
		return $this->aSchema;
	}
