...
abstract class BaseAgentHasUser extends BaseObject  implements Persistent {
  ...
  const PEER = 'AgentHasUserPeer';
	...
	/**
	 * Initializes internal state of BaseAgentHasUser object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     AgentHasUser The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(AgentHasUserPeer::USER_ID,AgentHasUserPeer::AGENT_ID,AgentHasUserPeer::IS_REGISTRAR_FOR,AgentHasUserPeer::IS_ADMIN_FOR))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->is_registrar_for = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
			$this->is_admin_for = ($row[$startcol + 7] !== null) ? (boolean) $row[$startcol + 7] : null;
			$this->resetModified();
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AgentHasUserPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseAgentHasUser:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
			...
			AgentHasUserPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUser->addAgentHasUsers($this);
			 */
		}
		return $this->aUser;
	}
	...
	public function getAgent(PropelPDO $con = null)
	{
		if ($this->aAgent === null && ($this->agent_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aAgent->addAgentHasUsers($this);
			 */
		}
		return $this->aAgent;
	}
