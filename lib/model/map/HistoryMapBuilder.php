...
class HistoryMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('TYPE_ID', 'TypeId', 'int', CreoleTypes::INTEGER, 'history_types', 'ID', true, null);
		...
		$tMap->addColumn('ICON', 'Icon', 'string', CreoleTypes::VARCHAR, false, 191);

		$tMap->addColumn('CLASS', 'Class', 'string', CreoleTypes::VARCHAR, false, 191);

		$tMap->addColumn('TEXT', 'Text', 'string', CreoleTypes::VARCHAR, false, 191);

		$tMap->addColumn('ASSETS', 'Assets', 'string', CreoleTypes::LONGVARCHAR, false, null);
