 ...
 */
class SchemaMapBuilder implements MapBuilder {
	...
	{
		$this->dbMap = Propel::getDatabaseMap(SchemaPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(SchemaPeer::TABLE_NAME);
		$tMap->setPhpName('Schema');
		$tMap->setClassname('Schema');
		...
		$tMap->addColumn('CHILD_UPDATED_USER_ID', 'ChildUpdatedUserId', 'INTEGER', false, null);
		...
		$tMap->addColumn('NS_TYPE', 'NsType', 'CHAR', true, null);
