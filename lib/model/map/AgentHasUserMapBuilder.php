 ...
 */
class AgentHasUserMapBuilder implements MapBuilder {
	...
	{
		$this->dbMap = Propel::getDatabaseMap(AgentHasUserPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(AgentHasUserPeer::TABLE_NAME);
		$tMap->setPhpName('AgentHasUser');
		$tMap->setClassname('AgentHasUser');
