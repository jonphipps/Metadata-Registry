...
/**
 * This class adds structure of 'project_user' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class ProjectUserMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.ProjectUserMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('project_user');
		$tMap->setPhpName('ProjectUser');
