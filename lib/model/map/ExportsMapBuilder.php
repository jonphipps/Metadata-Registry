...
/**
 * This class adds structure of 'exports' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class ExportsMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.ExportsMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('exports');
		$tMap->setPhpName('Exports');
		...
		$tMap->addColumn('EXPORTED_BY', 'ExportedBy', 'int', CreoleTypes::INTEGER, false, null);
