...
class ConceptProperty extends BaseConceptProperty
{
    ...
    {
        return $this->getProfileProperty()
                    ->getName();
    }
    ...
    {
        return $this->getConceptRelatedByConceptId()
                    ->getVocabulary();
    }
    ...
    public function getSkosPropertyName()
    {
        if (! $this->skos_property_name && $this->getSkosPropertyId()) {
            $this->skos_property_name = SkosPropertyPeer::retrieveByPK($this->getSkosPropertyId())
                                                        ->getName();
        }
