...
class ConceptPropertyPeer extends BaseConceptPropertyPeer
{
    ...
    public static function doSelectSearchResults(Criteria $c, $con = null)
    {
        ...
        $c->addSelectColumn(self::OBJECT);
        $c->addSelectColumn(self::SKOS_PROPERTY_ID);
        ...
        $c->addJoin(self::CONCEPT_ID, ConceptPeer::ID);
        $c->addJoin(self::SKOS_PROPERTY_ID, SkosPropertyPeer::ID);
     ...
     * @throws PropelException
     */
    public static function doSelectJoinProfilePropertyRelatedBySkosPropertyIdSortByProfileProperty(Criteria $c, $con = null)
    {
        $c = clone $c;
        ...
        return self::doSelectJoinProfilePropertyRelatedBySkosPropertyId($c, $con);

    }
} // ConceptPropertyPeer

sfPropelBehavior::add('ConceptProperty', [ 'paranoid' ]);
