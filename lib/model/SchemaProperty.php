<?php
  ...
  class SchemaProperty extends BaseSchemaProperty {
    ...
    public function saveSchemaProperty($userId) {
      ...
      if ($this->isModified() || $this->getCurrentSchemaPropertyI18n()->isModified() || $this->isNew()) {
        ...
        try {
          ...
          $columnsI18n = $i18n->modifiedColumns;
          //save it last
          ...
          foreach ($columnsI18n as $column) {
            $fieldName = SchemaPropertyI18nPeer::translateFieldName($column, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME);
            $object    = $i18n->getByName($column, BasePeer::TYPE_COLNAME);
            SchemaPropertyPeer::updateRelatedElements($i18n, $fieldName, $object, $objectId, $userId, $fieldIds, $statusId, $con);
          }
