        ...
        if ($this->isModified() || $this->isNew()) {
            ...
            try {
                ...
                foreach ($columns as $column) {
                    $fieldName =
                          SchemaPropertyPeer::translateFieldName($column, BasePeer::TYPE_COLNAME,
                    ...
                    SchemaPropertyPeer::updateRelatedElements($this, $fieldName, $object, $objectId, $userId, $fieldIds,
                          $statusId, $con);
                }
