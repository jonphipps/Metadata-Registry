...
class pakeGetopt
{
  ...
  public function __construct($options)
  {
    ...
    foreach ($options as $option)
    {
      if (!$option[0])
      {
        throw new pakeException("you must define a long option name! for option $option[1] ($option[3])");
      }
  ...
  public function get_option($option)
  {
    ...
    {
      throw new pakeException('you cannot get a value for a NO_ARGUMENT option');
    }
  }
