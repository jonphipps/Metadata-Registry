 ...
 * @version    $Id: sfMessageSource_MySQL.class.php 415 2008-04-04 19:30:57Z jphipps $
 * @package    symfony
 * @subpackage i18n
 */
...
class sfMessageSource_MySQL extends sfMessageSource
{
   ...
   *
   * @return mysqli resource MySQL connection.
  ...
  protected function getLastModified($source)
  {
    ...
    return $rs ? intval(mysqli_fetch_field_direct($rs, 0)) : 0;
  ...
  function save($catalogue = 'messages')
  {
    ...
    foreach ($messages as $message)
    {
      $count++;
      $inserted++;
      $message = mysqli_real_escape_string($message, $this->db);
