 ...
 * @version    SVN: $Id: sfInflector.class.php 63 2006-06-14 17:31:15Z jphipps $
 */
class sfInflector
{
  /**
   ...
   * @param boolean $separate_class_name_and_id_with_underscore Separate with underscore.
   *
   * @return string strong Foreign key
   */
