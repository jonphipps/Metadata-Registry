...
?>
<?php echo form_tag('schema/getcsv',
                    [
...
<fieldset id="sf_fieldset_defaults">
    ...
    <div id="form_row_schema_exportType" class="form-row"><?php echo label_for('exportType',
                                                                               __s('CSV Type'),
                                                                               'class=required id=label_for_schema_exportType') ?>
        <div id="form_row_content_schema_language" class="content<?php if ($sf_request->hasError('exportType')): ?> form-error<?php endif; ?>">
            <?php $value = select_tag('exportType',
                                      options_for_select([
    ...
    <div id="form_row_exclude_deprecated" class="form-row">
        ...
        <div id="form_row_content_exclude_deprecated" class="content<?php if ($sf_request->hasError('excludeDeprecated')): ?> form-error<?php endif; ?>">
            <?php echo checkbox_tag('excludeDeprecated',
                                    1,
                                    $sf_request->getAttribute('excludeDeprecated', false) ? 1 : 0,
                                    [ 'style' => "width:1em" ]) ?>
    ...
    <div id="form_row_exclude_generated" class="form-row">
        ...
        <div id="form_row_content_exclude_generated" class="content<?php if ($sf_request->hasError('excludeGenerated')): ?> form-error<?php endif; ?>">
            <?php echo checkbox_tag('excludeGenerated',
                                    1,
                                    $sf_request->getAttribute('excludeGenerated', false) ? 1 : 0,
                                    [ 'style' => "width:1em" ]) ?>
    ...
    <?php if (isset( $schema ) and count($schema->getLanguages()) > 1) : ?>
        ...
        <div id="form_row_content_export_language" class="content
            ...
            <?php if ($sf_request->hasError('addLanguage')): ?><?php echo form_error('addLanguage',
                                                                                     [ 'class' => 'form-error-msg', ]) ?><?php endif; ?>

            <?php
            $value = object_admin_select_language($schema,
                                                  'getLanguage',
                                                  [
    ...
    <div id="form_row_include_deleted" class="form-row">
        ...
        <div id="form_row_content_include_deleted" class="content<?php if ($sf_request->hasError('includeDeleted')): ?> form-error<?php endif; ?>">
            <?php echo checkbox_tag('includeDeleted',
                                    1,
                                    $sf_request->getAttribute('includeDeleted', false) ? 1 : 0,
                                    [ 'style' => "width:1em" ]) ?>
...
<?php include_partial('export_actions', [ 'schema' => $schema, ]) ?>
</form>
