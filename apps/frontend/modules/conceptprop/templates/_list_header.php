...
<?php if ($sf_params->get('concept_id')): ?>
  Properties <br />of <?php $action = $sf_context->getActionStack()->getLastEntry()->getActionInstance(); echo link_to('Concept', 'concept/list?vocabulary_id=' . $action->getVocabularyID()) ?>:
