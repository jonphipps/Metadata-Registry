...
<?php if ($sf_params->get('id')): ?>
  Property detail <br />for <?php $action = $sf_context->getActionStack()->getLastEntry()->getActionInstance(); echo link_to('Concept', 'concept/list?vocabulary_id=' . $action->getVocabularyID()) ?>:
