<?php slot('feeds');
  $rss['link'] = "@concept_history_feed_rss?IdType=" . $sf_params->get('IdType') . "&id=" . $sf_params->get($sf_params->get('IdType'));
  $rdf['link'] = "@concept_history_feed_rdf?IdType=" . $sf_params->get('IdType') . "&id=" . $sf_params->get($sf_params->get('IdType'));
  $atom['link'] = "@concept_history_feed_atom?IdType=" . $sf_params->get('IdType') . "&id=" . $sf_params->get($sf_params->get('IdType'));
