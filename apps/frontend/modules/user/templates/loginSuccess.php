...
<div class="in_form">
  <p><?php echo __('User Registration is only required if you want to register or maintain resources.') ?></p>
</div>
...
<?php echo form_tag($sf_request->getAttribute('newaccount', false) ? '@add_account' : '@login', 'id=login_form class=form') ?>
  ...
  <div id="new_account"<?php echo $sf_request->getAttribute('newaccount', false) ? '' : ' style="display: none"' ?>>
    ...
    <br class="clearleft"/>
    <div class="small in_form"><?php echo __('The Registry will never disclose this address to a third party') ?></div>
