<?php
  ...
  if(isset($version))
  {
    ...
    echo link_to('RDF', $sf_user->getAttribute('vocabulary')->getUri() . '/version/' .  $versionName . '.rdf', array('title' => 'Retrieve RDF for this vocabulary version'));
    echo "&nbsp;" . link_to('XSD', $sf_user->getAttribute('vocabulary')->getUri() . '/version/' .  $versionName . '.xsd', array('title' => 'Retrieve an XML Schema for this vocabulary version'));
  }
  else
  {
