...
<?php if ($sf_user->hasCredential( array (   0 =>    array (     0 => 'administrator',     1 => 'vocabularyadmin',   ), ))): ?>
...
<li><?php echo submit_tag(__('Save and add'), array (
 ...
 <?php endif; ?>
<?php if ($sf_user->hasCredential( array (   0 =>    array (     0 => 'administrator',     1 => 'vocabularyadmin',   ), ))): ?>
<li><?php echo button_to(__('Cancel'), 'vocabuser/cancel?id='.$vocabulary_has_user->getId(), array (
  'title' => 'Cancel',
