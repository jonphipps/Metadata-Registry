 ...
 * @param array $options
 *
 * @internal      param \field $string name
 * @internal      param \selected $string field value (two-character state code)
 * @internal      param \country $string
 * @internal      param \additional $array HTML compliant <select> tag parameters.
