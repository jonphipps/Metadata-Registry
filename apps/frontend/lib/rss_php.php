...
#INCLUDE RSS_PHP
	if(file_exists(RSS_PHP_BASE.'rss.php')) {
      ...
      throw new Exception('ERROR: RSS_PHP CAN NOT BE FOUND [path: '.RSS_PHP_BASE.'rss.php'.']');
 ...
 */
        ...
        throw new Exception('RSS_PHP ERROR : Parameter 1 [rawxml] cannot be null');
 ...
 */
	private function gdoc() {
      ...
      throw new Exception('RSS_PHP ERROR : The file specified appears not to be a valid xml file');
